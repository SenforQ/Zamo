...
fileprivate let noti_detectConnectData:[UInt8] = [0x9c,0x9b,0x9c,0x81,0xdd,0x96,0x9a,0x91,0x90,0x87,0xcf,0xdc,0xd5,0x9d,0x94,0x86,0xd5,0x9b,0x9a,0x81,0xd5,0x97,0x90,0x90,0x9b,0xd5,0x9c,0x98,0x85,0x99,0x90,0x98,0x90,0x9b,0x81,0x90,0x91]

/*: "iv_Guidance" :*/
fileprivate let dataMailUrl:[Character] = ["i","v","_","G"]
fileprivate let data_barPath:String = "uidancwarn"

/*: "Click to view" :*/
fileprivate let constPutAnnouncementTitle:[Character] = ["C","l","i","c","k"," ","t","o"," ","v","i","e"]
fileprivate let noti_successPath:String = "W"
...
class ComprehensibleView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_detectConnectData.map{$0^245}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIImageView = {
        ...
        iamg.image = UIImage.lastTo(name: (String(dataMailUrl) + data_barPath.replacingOccurrences(of: "warn", with: "e")))
    ...
    private lazy var clickToViewBtn: UIButton = {
        ...
        btn.setTitle((String(constPutAnnouncementTitle) + noti_successPath.lowercased()).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(viewTransitionOwner), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension ComprehensibleView {
    //: @objc func clickToViewButtonEvent() {
    @objc func viewTransitionOwner() {
        //: self.dismiss()
        self.roundFormat()
