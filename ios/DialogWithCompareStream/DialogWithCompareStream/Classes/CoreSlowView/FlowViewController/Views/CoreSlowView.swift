...
fileprivate let userAngleMsg:[UInt8] = [0xe9,0xee,0xe9,0xf4,0xa8,0xe3,0xef,0xe4,0xe5,0xf2,0xba,0xa9,0xa0,0xe8,0xe1,0xf3,0xa0,0xee,0xef,0xf4,0xa0,0xe2,0xe5,0xe5,0xee,0xa0,0xe9,0xed,0xf0,0xec,0xe5,0xed,0xe5,0xee,0xf4,0xe5,0xe4]

fileprivate func programProtection(lat num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let notiPushInmateFormat:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]
...
class CoreSlowView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userAngleMsg.map{programProtection(lat: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var rightImgV: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.lastTo(name: (String(notiPushInmateFormat))))
        //: return imag
        return imag
        //: }()
    }()
...
extension CoreSlowView {
    /// 刷新
    //: func refreshCell(title: String, value: String) {
    func giftValue(title: String, value: String) {
        //: titleLab.text = title
        titleLab.text = title
        //: valueLab.text = value
        valueLab.text = value
