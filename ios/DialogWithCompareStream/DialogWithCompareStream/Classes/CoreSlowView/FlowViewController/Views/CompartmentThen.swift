...
fileprivate let kCigaretteMessage:[UInt8] = [0xd4,0xd3,0xd4,0xc9,0x95,0xde,0xd2,0xd9,0xd8,0xcf,0x87,0x94,0x9d,0xd5,0xdc,0xce,0x9d,0xd3,0xd2,0xc9,0x9d,0xdf,0xd8,0xd8,0xd3,0x9d,0xd4,0xd0,0xcd,0xd1,0xd8,0xd0,0xd8,0xd3,0xc9,0xd8,0xd9]

private func keepComprehensive(land num: UInt8) -> UInt8 {
    return num ^ 189
}

/*: "icon_lounge" :*/
fileprivate let appLabelId:String = "retain againsticon_l"

/*: "#777777" :*/
fileprivate let show_marginMessage:String = "#77777"
fileprivate let userUpperStr:String = "7"

/*: "UID: :*/
fileprivate let notiIdentifyStr:String = "UID:edge strength next"
...
class CompartmentThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kCigaretteMessage.map{keepComprehensive(land: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.lastTo(name: (String(appLabelId.suffix(6)) + "ounge"))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (show_marginMessage.capitalized + userUpperStr.capitalized))
        //: return lab
        return lab
        //: }()
    }()
...
extension CompartmentThen {
    ...
    func towardPlatform(model: MarketHandyJSON) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.contactMoment(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .userLogColor() : .roundChromaticColor()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(notiIdentifyStr.prefix(4))) + "\(model.uid)"
