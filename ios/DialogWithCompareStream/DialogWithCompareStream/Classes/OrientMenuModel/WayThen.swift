...
fileprivate let app_playerMessage:[UInt8] = [0xb9,0xbe,0xb9,0xa4,0xf8,0xb3,0xbf,0xb4,0xb5,0xa2,0xea,0xf9,0xf0,0xb8,0xb1,0xa3,0xf0,0xbe,0xbf,0xa4,0xf0,0xb2,0xb5,0xb5,0xbe,0xf0,0xb9,0xbd,0xa0,0xbc,0xb5,0xbd,0xb5,0xbe,0xa4,0xb5,0xb4]

private func thanBuild(straight num: UInt8) -> UInt8 {
    return num ^ 208
}

/*: "#292929" :*/
fileprivate let data_profitMessage:String = "#292929"

/*: "9999999" :*/
fileprivate let showMemoryMsg:[Character] = ["9","9"]
fileprivate let show_adRareTitle:[Character] = ["9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let dataJustFatalKey:String = "icon_load add lock quality production"

/*: "icon_gift_more_arrow" :*/
fileprivate let noti_motivationSaleData:[Character] = ["i","c","o","n","_","g","i","f","t","_","m"]
fileprivate let dataEstimateStr:[Character] = ["o","r","e","_","a","r","r","o","w"]

/*: "Hot" :*/
fileprivate let show_yetBetweenValue:[Character] = ["H","o","t"]

/*: "VIP" :*/
fileprivate let userResistanceTitle:String = "accessIP"

/*: "Bags" :*/
fileprivate let data_transportTitle:String = "Bagstranslate wealthy agency"

/*: "icon_gift_num_arrow" :*/
fileprivate let const_shadeRankValue:String = "protocol backicon_g"
fileprivate let app_depthName:[Character] = ["u","m","_","a","r","r","o","w"]

/*: "Send" :*/
fileprivate let userPermissionMsg:String = "Sendeye message filter"

/*: "nav_back_black_nor" :*/
fileprivate let noti_levelId:String = "reject selection trigger samenav_"
fileprivate let k_cancelFormat:String = "interest resource replace sweep_black"
fileprivate let dataGreetTitle:String = "moment phase address_nor"

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let kQuoteData:[UInt8] = [0x16,0x2a,0x27,0x62,0x2c,0x37,0x2f,0x20,0x27,0x30,0x62,0x2d,0x24,0x62,0x25,0x2b,0x24,0x36,0x31,0x62,0x21,0x23,0x2c,0x2c,0x2d,0x36,0x62,0x20,0x27,0x62,0x2e,0x27,0x31,0x31,0x62,0x36,0x2a,0x23,0x2c,0x62,0x73]

private func sumeractionMedication(normal num: UInt8) -> UInt8 {
    return num ^ 66
}

/*: "Please select a gift" :*/
fileprivate let notiTitleureNameActorText:String = "sum good weight random issuePlea"
fileprivate let notiDialExplainId:String = "eleccreature"
fileprivate let user_headData:String = " a giftdoc heart letter"

/*: "Please select an object" :*/
fileprivate let notiTunUrl:String = "area jaw kind agentPleas"
fileprivate let notiIdentityStr:String = "attention forward flexible tellct an obj"
fileprivate let main_holdValue:[Character] = ["e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let user_favoriteId:[UInt8] = [0x6b,0x63,0x6f,0x6c,0x6e,0x75,0x20,0x6f,0x74,0x20,0x74,0x66,0x69,0x67,0x20,0x64,0x65,0x72,0x69,0x73,0x65,0x64,0x20,0x65,0x68,0x74,0x20,0x74,0x63,0x65,0x6c,0x65,0x53]

/*: "Select object >" :*/
fileprivate let user_clubData:String = "cancel signal successfulSelec"
fileprivate let showAfterName:String = "t objeactivity route present collect"

/*: "It looks like there's nothing" :*/
fileprivate let kEaseTitle:[Character] = ["I","t"," ","l","o","o","k","s"," ","l","i","k","e"," "]
fileprivate let k_rawPathEventKey:[Character] = ["t","h","e","r","e","\'","s"," ","n","o","t","h","i","n","g"]

/*: "FF75A4" :*/
fileprivate let constJustUrl:String = "keykey75A4"

/*: "E570FF" :*/
fileprivate let constSpreadMsg:String = "E570tip"

/*: "Ask for" :*/
fileprivate let noti_homeOwnerContent:String = "Ask forunknown appearance"

/*: " Select %@ > " :*/
fileprivate let data_comeUrl:[Character] = [" ","S","e","l","e","c","t"]
fileprivate let dataSuccessfullyValue:[Character] = [" ","%","@"," ",">"," "]

/*: "All Numbers" :*/
fileprivate let data_allRequestPath:String = "guide"
fileprivate let noti_earnFormat:[Character] = ["l","l"," ","N","u","m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let dataThirdMessage:String = "spy sight border laugh liftView"
fileprivate let notiEditKey:String = "easy action edit boldiled "
fileprivate let main_definitionValue:String = "appearpt"
fileprivate let main_boardUrl:String = "local compel bulbion >"

/*: "9999" :*/
fileprivate let k_minimumHowStr:String = "9999"

/*: "Custom" :*/
fileprivate let notiAgentText:[Character] = ["C","u","s","t","o"]
fileprivate let dataGolfMessage:String = "fire"

/*: "mf_coin" :*/
fileprivate let main_yellowKey:String = "pure document sub bridemf_coin"

/*: "showBagsRed" :*/
fileprivate let const_policyStr:String = "min text catch typeshowB"
...
enum DeviseExpressionConvertible: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: TipTransformable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: TipTransformable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: TipTransformable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: TipTransformable, _ num: String, _ model: StandCoreHandyJSON) -> Void
// 隐藏礼物面板Block
...
private let kExplainBlockData = 44.0
//: let GiftScrollContentView_H = 252.0
let notiMoviePath = 252.0
//: private let pageControl_H = 7.0
private let constDataKey = 7.0
//: private let bottomView_H = 44.0
private let user_showStr = 44.0

//: class TalkingChatGiftView: UIView {
class WayThen: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = kExplainBlockData + notiMoviePath + constDataKey + user_showStr + userDiskUrl
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var style: AuthorizeSequence = .normal
    //: var giftSelectedModel = TalkingGiftSelectedModel()
    var giftSelectedModel = TrimTransformable()
    //: var chatRoomgiftSelectedMemberModel: TalkingChatRoomMemberModel?
    var chatRoomgiftSelectedMemberModel: StandCoreHandyJSON?
    //: var popView: TalkingPopView?
    var popView: RiseView?
    //: var meneView = DropDownMemberMenuView()
    var meneView = AccessibleDataSource()
    ...
    private var titlesArr = [DeviseExpressionConvertible]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = DeviseExpressionConvertible.Hot
    ...
    init(frame: CGRect = .zero, style: AuthorizeSequence = .normal, titlesArr: [DeviseExpressionConvertible] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_playerMessage.map{thanBuild(straight: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: constBlockIdentityContent, width: show_objectValue, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (data_profitMessage.capitalized))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.factorSource(width: show_objectValue, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: show_objectValue, height: kExplainBlockData)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (data_profitMessage.capitalized))
    ...
    private lazy var moneyBtn: EarthThen = {
        //: let btn = TalkingButton()
        let btn = EarthThen()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.landEnableSize(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((String(showMemoryMsg) + String(show_adRareTitle)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.lastTo(name: (String(dataJustFatalKey.prefix(5)) + "coin")), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(rechargeStyle), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.lastTo(name: (String(noti_motivationSaleData) + String(dataEstimateStr)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.judgeAdvertising(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.judgeAdvertising(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(DirtyReusableView.self, forCellWithReuseIdentifier: DirtyReusableView.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: SchemeFlowLayout = //: return hotGiftCollectionView.collectionViewLayout as! SchemeFlowLayout
        hotGiftCollectionView.collectionViewLayout as! SchemeFlowLayout
    //: }()
    ...
    private lazy var titleScrollView: WritingFlowSegmentView = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(show_yetBetweenValue)).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((userResistanceTitle.replacingOccurrences(of: "access", with: "V")).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(data_transportTitle.prefix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = TipSegmentStyle()
        ...
        let scrollview = WritingFlowSegmentView(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(kExplainBlockData)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if DriveReactiveCompatible.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = EverlastinglyReactiveCompatible.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = EverlastinglyReactiveCompatible.laden() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !RugReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.thirdRevenue().cgColor
    ...
    private lazy var giftNumButton: EarthThen = {
        ...
        btn.setImage(UIImage.lastTo(name: (String(const_shadeRankValue.suffix(6)) + "ift_n" + String(app_depthName))), for: .normal)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.landEnableSize(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.thirdRevenue()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(userPermissionMsg.prefix(4))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(minimizeArrow), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: constBlockIdentityContent - CGFloat(keyborHeight) - 44, width: show_objectValue, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.lastTo(name: (String(noti_levelId.suffix(4)) + "back" + String(k_cancelFormat.suffix(6)) + String(dataGreetTitle.suffix(4)))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.pastAccess(color: .thirdRevenue(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(userPermissionMsg.prefix(4))).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.outBarMsg(showMsg: String(bytes: kQuoteData.map{sumeractionMedication(normal: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.outBarMsg(showMsg: (String(notiTitleureNameActorText.suffix(4)) + "se s" + notiDialExplainId.replacingOccurrences(of: "creature", with: "t") + String(user_headData.prefix(7))).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.outBarMsg(showMsg: (String(notiTunUrl.suffix(5)) + "e sele" + String(notiIdentityStr.suffix(9)) + String(main_holdValue)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = DeviseExpressionConvertible(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.endSpace(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: TipTransformable = dataArr[index] as! TipTransformable
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.thirdRevenue()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(keepFor(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(facultyBirth(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(askLimit(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: user_favoriteId.reversed(), encoding: .utf8)!.localized
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(user_clubData.suffix(5)) + String(showAfterName.prefix(6)) + "ct >").localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(quoteAsk), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(processClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.landEnableSize(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(kEaseTitle) + String(k_rawPathEventKey)).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.tillOfCreation(colors: [UIColor(hex: (constJustUrl.replacingOccurrences(of: "key", with: "F")))!.cgColor, UIColor(hex: (constSpreadMsg.replacingOccurrences(of: "tip", with: "FF")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.landEnableSize(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(noti_homeOwnerContent.prefix(7))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(carry), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension WayThen {
    ...
    @objc func merge() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: constBlockIdentityContent, width: show_objectValue, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func memberDismiss() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: constBlockIdentityContent - self.contentHeight, width: show_objectValue, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func policy() {
        ...
        guard let dataType = DeviseExpressionConvertible(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.endSpace(dataType: dataType)
    ...
    @objc func quoteAsk() {
        ...
        meneView = AccessibleDataSource(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func processClick() {
        //: dismissView()
        merge()
        //: TalkingAppPushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        RiseMalePushManager.share.monthType(webViewType: .luckyBlindBox)
    }
...
extension WayThen {
    ...
    func commonFraction(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.endSpace(dataType: self.currType) as! [TipTransformable]
            // 找到当前背包礼物索引，更新数量
            ...
            RugReactiveCompatible.share.briskUp(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.holdOffeSOwn(force: true)
        }
    }
}

// MARK: - ExtensiveViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension WayThen: ExtensiveViewDelegate {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func meanSunTrack(model: StandCoreHandyJSON) {
        //: self.chatRoomgiftSelectedMemberModel = model
        self.chatRoomgiftSelectedMemberModel = model
        //: seleteObjectBtn.setTitle(" Select %@ > ".localizedArguments(model.nickname), for: .normal)
        seleteObjectBtn.setTitle((String(data_comeUrl) + String(dataSuccessfullyValue)).takeHomeDiskMini(model.nickname), for: .normal)
    }
    ...
    func readyMembers() {
        ...
        if model.nickname == (data_allRequestPath.replacingOccurrences(of: "guide", with: "A") + String(noti_earnFormat)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! StandCoreHandyJSON
    ...
    func quantityerestChoice(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(dataThirdMessage.suffix(4)) + " deta" + String(notiEditKey.suffix(5)) + "descr" + main_definitionValue.replacingOccurrences(of: "appear", with: "i") + String(main_boardUrl.suffix(5))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension WayThen: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func endSpace(dataType: DeviseExpressionConvertible) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return RugReactiveCompatible.share.assessment(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func carhopOner() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return RugReactiveCompatible.share.perInput()
    }
    ...
    func backSchedule(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == RecordingEquatable.myStery.rawValue)
        }
    ...
    @objc fileprivate func keepFor(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (k_minimumHowStr.capitalized)
            //: } else {
        } else {
    ...
    @objc func askLimit(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: constBlockIdentityContent - CGFloat(keyborHeight) - 44, width: show_objectValue, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func facultyBirth(notification _: NSNotification) {
    ...
    func someSocialField() {
        //: let sendingItems = giftSendItems()
        let sendingItems = carhopOner()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(countDarkIndex(index: i))
//            let giftNumArrModel: LifetimeArrModel = sendingItems[i] as! LifetimeArrModel
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(notiAgentText) + dataGolfMessage.replacingOccurrences(of: "fire", with: "m")).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.VolumeBe.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = AccessibleReactiveCompatible.pullBack(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func third() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? DirtyReusableView
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.male(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = DeviseExpressionConvertible(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = endSpace(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = DirtyReusableView.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! DirtyReusableView
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = DeviseExpressionConvertible(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = endSpace(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: TipTransformable = dataArr[indexPath.row] as! TipTransformable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.rowCompartment(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.observerQueryed(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = DeviseExpressionConvertible(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = endSpace(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == RecordingEquatable.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == RecordingEquatable.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == RecordingEquatable.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                snapBridgeRubric(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = underCrop(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = tillRoot(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            snapBridgeRubric(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: DirtyReusableView = giftSelectedModel.lastHotCell as! DirtyReusableView
                //: cell.setChecked(checked: false)
                cell.observerQueryed(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: DirtyReusableView = self.hotGiftCollectionView.cellForItem(at: indexPath) as! DirtyReusableView
            //: currentCell.setChecked(checked: true)
            currentCell.observerQueryed(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.materialAnimated(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.endSpace(dataType: self.currType)
    ...
    func holdOffeSOwn(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + show_objectValue
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < show_objectValue ? show_objectValue : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / show_objectValue - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(show_objectValue) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = DeviseExpressionConvertible.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = RugReactiveCompatible.share.close(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.used(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && MentionTriggerAppManager.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == DeviseExpressionConvertible.Hot && self.style == .normal && MentionTriggerAppManager.share.loginUserMode.sex == TopicKeyRepresentable.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == RecordingEquatable.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                quantityerestChoice(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func effect() {
        ...
        self.giftSelectedModel = TrimTransformable()
...
extension WayThen: SpeakViewDelegate {
    ...
    func snapBridgeRubric(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.cuttingEdge(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.arcView(view: self.window!)
    ...
    func countDarkIndex(index: Int) -> Int {
        //: let sendingItems = giftSendItems()
        let sendingItems = carhopOner()
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: LifetimeArrModel = sendingItems[index] as! LifetimeArrModel
    ...
    func underCrop(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< carhopOner().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: LifetimeArrModel = carhopOner()[i] as! LifetimeArrModel
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func tillRoot(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > carhopOner().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension WayThen {
    ...
    private func fieldSubviews() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: show_objectValue, height: constBlockIdentityContent - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(merge)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(notiMoviePath)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(show_objectValue)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(show_objectValue - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(constDataKey)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(user_showStr)
        }
    ...
    private func factorBond() {
        //: MentionTriggerAppManager.share.loginUserMode.rx
        MentionTriggerAppManager.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(main_yellowKey.suffix(7))))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.backSchedule(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        RugReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(const_policyStr.suffix(5)) + "agsRed"))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                RugReactiveCompatible.share.display(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: MentionTriggerAppManager.share.loginUserMode.mf_coin)
                    self.backSchedule(needReload: true, mf_coin: MentionTriggerAppManager.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
