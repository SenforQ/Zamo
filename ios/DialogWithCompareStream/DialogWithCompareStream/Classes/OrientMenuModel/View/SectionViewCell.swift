...
fileprivate let notiAllowNightStr:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_home_boy" :*/
fileprivate let mainScopeUrl:[Character] = ["i","c","o","n","_","h","o","m","e","_","b","o","y"]

/*: "icon_home_girl" :*/
fileprivate let dataMerelyTitle:String = "alliance skipicon_"
fileprivate let notiSufficientId:[Character] = ["g","i","r","l"]
...
class SectionViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiAllowNightStr.reversed(), encoding: .utf8)!)
    }
...
extension SectionViewCell {
    ...
    func bottomKeep(model: StandCoreHandyJSON, type: MentionSignatureKeyRepresentable) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.lastTo(name: (String(mainScopeUrl))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.lastTo(name: (String(dataMerelyTitle.suffix(5)) + "home_" + String(notiSufficientId))), for: .normal)
        //: break
        //: default:
        default:
            //: break
