...
/*: "bg_chat_honey_left" :*/
fileprivate let userIncomeFormat:String = "ease somethingbg_ch"
fileprivate let noti_happyContent:[Character] = ["n","e","y","_","l","e","f","t"]

/*: "bg_chat_honey_right" :*/
fileprivate let dataDecreaseTitle:String = "bg_chatmap anima going ok female"
fileprivate let const_enoughUrl:[Character] = ["_","h","o","n","e","y","_","r","i","g","h","t"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let noti_readyMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#FA74B7" :*/
fileprivate let user_currentMsg:String = "observer beauty note#FA74"
fileprivate let noti_horseStr:[Character] = ["B","7"]

/*: "icon_coin" :*/
fileprivate let k_drawingId:[Character] = ["i","c","o","n","_","c","o","i","n"]
...
//: @objcMembers public class OutsideCellData: TalkingChatMsgBaseCellData {
@objcMembers public class OutsideCellData: SumroductionCellData {
    ...
    override public init(direction: BeTransformable) {
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.bubbleImg = UIImage.tillLanguageUnitText(name: (String(userIncomeFormat.suffix(5)) + "at_ho" + String(noti_happyContent)))
            ...
            self.bubbleImg = UIImage.tillLanguageUnitText(name: (String(dataDecreaseTitle.prefix(7)) + String(const_enoughUrl)))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_readyMsg.reversed(), encoding: .utf8)!)
    }
    ...
    public lazy var attributedString: NSMutableAttributedString = {
        ...
        let attr = fitModel(giftModel: self.msgModel)
        //: return attr
        return attr
        //: }()
    }()
    ...
    func fitModel(giftModel: OrganModel) -> NSMutableAttributedString {
        //: let attr = NSMutableAttributedString.init()
        let attr = NSMutableAttributedString()
        //: let font = UIFont.pingfangRugularFont(fontSize: 16)
        let font = UIFont.activeBeautyNative(fontSize: 16)
        //: let giftname = changeGiftName(giftmodel: giftModel.msgInfo.wantGift)
        let giftname = windowCutGiftmodel(giftmodel: giftModel.msgInfo.wantGift)
        ...
        let attr1 = NSMutableAttributedString(string: str, attributes: [.font: font, .foregroundColor: UIColor.roundChromaticColor()])
        //: let attr2 = NSMutableAttributedString.init(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor.init(hex: "#FA74B7")!])
        let attr2 = NSMutableAttributedString(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(user_currentMsg.suffix(5)) + String(noti_horseStr)))!])
        ...
        let attr3 = NSMutableAttributedString(string: "\(giftModel.msgInfo.wantGift.giftPrice)", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(user_currentMsg.suffix(5)) + String(noti_horseStr)))!])
        ...
        giftImgV.alter(urlStr: giftModel.msgInfo.wantGift.giftIcon)
        ...
        giftImgV2.image = UIImage.lastTo(name: (String(k_drawingId)))
    ...
    func windowCutGiftmodel(giftmodel: RedModel) -> String {
        ...
        if ProjectionThen.share.interfaceLang == ExtensiveLangType.en.rawValue {
            ...
            gameName = giftmodel.giftNameI18n[ExtensiveLangType.en.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ExtensiveLangType.ar.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ExtensiveLangType.es.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ExtensiveLangType.pt.rawValue] as? NSString ?? ""
        }
