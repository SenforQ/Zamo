...
@objcMembers public class StandReactiveCompatible: NSObject {
    ...
    class func tar() -> StandReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = StandReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func delayTo() -> StandReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = StandReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func occurSystem() -> StandReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = StandReactiveCompatible.init(isIncomming: false)
    ...
    class func telegram() -> StandReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = StandReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func soul() -> StandReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = StandReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
