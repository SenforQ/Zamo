...
let dataDetailFormat = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let noti_successCollectionValue = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let main_succeedRequestCornerFormat = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct TrapModelType: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
