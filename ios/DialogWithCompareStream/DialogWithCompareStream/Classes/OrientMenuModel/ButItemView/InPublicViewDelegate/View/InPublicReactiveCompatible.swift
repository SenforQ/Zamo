...
fileprivate let showFeeUrl:[UInt8] = [0x99,0x9e,0x99,0xa4,0x58,0x93,0x9f,0x94,0x95,0xa2,0x6a,0x59,0x50,0x98,0x91,0xa3,0x50,0x9e,0x9f,0xa4,0x50,0x92,0x95,0x95,0x9e,0x50,0x99,0x9d,0xa0,0x9c,0x95,0x9d,0x95,0x9e,0xa4,0x95,0x94]

fileprivate func netOpportunity(turn num: UInt8) -> UInt8 {
...
// __CLOSE_PRINT__
//
//  InPublicReactiveCompatible.swift
//  AbroadTalking
//
...
class InPublicReactiveCompatible: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [LifetimeArrModel()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showFeeUrl.map{netOpportunity(turn: $0)}, encoding: .utf8)!)
    }
    ...
    func glycerolize(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.todaySkinColor()
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.judgeAdvertising(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.judgeAdvertising(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension InPublicReactiveCompatible {
    // 添加视图
