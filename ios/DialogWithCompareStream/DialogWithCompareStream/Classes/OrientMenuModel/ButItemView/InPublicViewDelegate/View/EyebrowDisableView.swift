...
fileprivate let main_finishName:[UInt8] = [0xe2,0xe7,0xe2,0xed,0xa1,0xdc,0xe8,0xdd,0xde,0xeb,0xb3,0xa2,0x99,0xe1,0xda,0xec,0x99,0xe7,0xe8,0xed,0x99,0xdb,0xde,0xde,0xe7,0x99,0xe2,0xe6,0xe9,0xe5,0xde,0xe6,0xde,0xe7,0xed,0xde,0xdd]

fileprivate func panelAnother(universal num: UInt8) -> UInt8 {
...
/*: "bg_vip" :*/
fileprivate let app_approximateValue:String = "literal chin benefit used shrinkbg_vip"
...
class EyebrowDisableView: UIView {
    //: var callBlock: ((_ type: CallMenuType) -> Void)?
    var callBlock: ((_ type: BorderHeOffsetTarget) -> Void)?
    //: private var popView: TalkingPopView?
    private var popView: RiseView?
    //: private var content = "" // 展示内容
    private var content = "" // 展示内容
    //: private var type = CallMenuType.VideoCall
    private var type = BorderHeOffsetTarget.VideoCall // 类型

    //: init(type: CallMenuType, content: String) {
    init(type: BorderHeOffsetTarget, content: String) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_finishName.map{panelAnother(universal: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.lastTo(name: (String(app_approximateValue.suffix(6))))
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(receipts), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension EyebrowDisableView {
    ...
    private func layOverConstraint() {
