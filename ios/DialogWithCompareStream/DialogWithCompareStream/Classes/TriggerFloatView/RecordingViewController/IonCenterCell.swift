...
fileprivate let main_gravityValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let data_shiftMsg:[Character] = ["b","t","n","_","m","e","_","e","d"]
fileprivate let noti_jungleMsg:[Character] = ["i","t"]

/*: "icon_me_lw" :*/
fileprivate let mainSubFormat:[Character] = ["i","c","o","n","_","m","e","_","l","w"]

/*: " Reward" :*/
fileprivate let constEnableerProcedureTitle:String = "average horse match R"
fileprivate let user_wealthyBringKey:String = "ewearthd"

/*: "FF506D" :*/
fileprivate let showConveyUrl:String = "FF506capable"
...
class IonCenterCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_gravityValue.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.lastTo(name: (String(data_shiftMsg) + String(noti_jungleMsg))))
        //: return imag
        return imag
        //: }()
    }()
    ...
    private lazy var taskCenterBtn: UIButton = {
        ...
        btn.setImage(UIImage.lastTo(name: (String(mainSubFormat))), for: .normal)
        //: btn.setTitle(" Reward".localized, for: .normal)
        btn.setTitle((String(constEnableerProcedureTitle.suffix(2)) + user_wealthyBringKey.replacingOccurrences(of: "earth", with: "ar")).localized, for: .normal)
        //: btn.setTitleColor(UIColor.init(hex: "FF506D"), for: .normal)
        btn.setTitleColor(UIColor(hex: (showConveyUrl.replacingOccurrences(of: "capable", with: "D"))), for: .normal)
...
extension IonCenterCell {
    ...
    private func brightObject() {
        ...
        backView.frame = CGRect(x: 15, y: 0, width: show_objectValue - 30, height: backView_h)
        ...
        if index == 0, islast {
            ...
            backView.factorSource(width: backView.frame.size.width,
