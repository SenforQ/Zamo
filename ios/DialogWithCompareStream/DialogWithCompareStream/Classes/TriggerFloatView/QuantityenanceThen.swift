...
fileprivate let notiRoundingFormat:[UInt8] = [0x48,0x4f,0x48,0x55,0x9,0x42,0x4e,0x45,0x44,0x53,0x1b,0x8,0x1,0x49,0x40,0x52,0x1,0x4f,0x4e,0x55,0x1,0x43,0x44,0x44,0x4f,0x1,0x48,0x4c,0x51,0x4d,0x44,0x4c,0x44,0x4f,0x55,0x44,0x45]

private func paraNotice(life num: UInt8) -> UInt8 {
    return num ^ 33
}

/*: "img_match_shadow" :*/
fileprivate let appSystemName:String = "solar literal modify ting panimg_ma"
fileprivate let dataRemindFormat:String = "hadaboutw"

/*: "icon_match_topshowdown" :*/
fileprivate let main_faceYouUrl:String = "line ta week nighticon_mat"
fileprivate let const_buryKey:String = "ch_tunit round along here"
fileprivate let data_untilBrowMsg:String = "OPSHO"

/*: "Matching..." :*/
fileprivate let main_scaleKey:String = "below scan boyMatch"
fileprivate let showSegmentStreetUrl:String = "my guide lating..."

/*: "get json error" :*/
fileprivate let notiBusinessValue:[Character] = ["g","e","t"," ","j","s","o","n"," ","e","r","r","o"]
fileprivate let dataRemindProfitId:String = "composition"

/*: "img_home_shadow" :*/
fileprivate let notiHistoryStr:String = "earnings orimg_"
fileprivate let appApplicationName:String = "SHADOW"

/*: "icon_home_girl" :*/
fileprivate let constFemaleMsg:[Character] = ["i","c","o","n","_","h","o","m","e","_","g","i","r","l"]
...
typealias TouchCallBlock = (_ model: FormaliseHandyJSON) -> Void

//: class TalkingClubCardItemCell: TalkingClubCardViewCell {
class QuantityenanceThen: PointToCellThen {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiRoundingFormat.map{paraNotice(life: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var gradientShadowImageView: UIImageView = {
        ...
        imageView.image = UIImage.lastTo(name: (String(appSystemName.suffix(6)) + "tch_s" + dataRemindFormat.replacingOccurrences(of: "about", with: "o")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var topShowdImageView: UIImageView = {
        ...
        imageView.image = UIImage.lastTo(name: (String(main_faceYouUrl.suffix(8)) + String(const_buryKey.prefix(4)) + data_untilBrowMsg.lowercased() + "wdown"))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var sexBtn: UIButton = {
        ...
        btn.titleLabel?.font = .landEnableSize(type: .Medium, fontSize: 13)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var matchTipsLabel: UILabel = {
        ...
        label.text = (String(main_scaleKey.suffix(5)) + String(showSegmentStreetUrl.suffix(6))).localized
        //: label.isHidden = true
        label.isHidden = true
        //: return label
        return label
    ...
    lazy var callPlayer: SVGAPlayer = {
        ...
        let url = AliveEffectTool.default.proscenium(type: .Match_userCall)
        //: do {
        do {
            ...
            printLog(message: (String(notiBusinessValue) + dataRemindProfitId.replacingOccurrences(of: "composition", with: "r")))
        }
        //: return player
        return player
        //: }()
...
extension QuantityenanceThen {
    //: func setCellData(model: TalkingMatchResultModel) {
    func upendThroughPtolemaicSystem(model: FormaliseHandyJSON) {
        //: self.model = model
        self.model = model
        ...
        if model.cover.count > 0 {
            ...
            userImageView.choiceRest(urlStr: model.cover, placeImg: UIImage.lastTo(name: (String(notiHistoryStr.suffix(4)) + "home_" + appApplicationName.lowercased())))
            ...
            userImageView.choiceRest(urlStr: model.headPic, placeImg: UIImage.lastTo(name: (String(notiHistoryStr.suffix(4)) + "home_" + appApplicationName.lowercased())))
            //: } else {
        } else {
            //: userImageView.image = UIImage.BundleImageNamed(name: "img_home_shadow")
            userImageView.image = UIImage.lastTo(name: (String(notiHistoryStr.suffix(4)) + "home_" + appApplicationName.lowercased()))
        }
        //: userIconImg.setUrlImage(urlStr: model.headPic, placeImg: nil)
        userIconImg.contactMoment(urlStr: model.headPic, placeImg: nil)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
        sexBtn.setBackgroundImage(UIImage.lastTo(name: (String(constFemaleMsg))), for: .normal)
