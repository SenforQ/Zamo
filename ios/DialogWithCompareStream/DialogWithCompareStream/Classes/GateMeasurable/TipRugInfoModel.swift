...
struct TipRugInfoModel: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: AccessibleMomentModel?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [WouldMeasurable]? // 相册
    ...
    var aiExtraInfo = ModelHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct WouldMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func giftIndex(compareTo: WouldMeasurable) -> Bool {
        //: return
        return
...
struct ModelHandyJSON: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
