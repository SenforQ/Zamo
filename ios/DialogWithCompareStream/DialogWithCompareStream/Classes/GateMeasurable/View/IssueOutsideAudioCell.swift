...
fileprivate let app_serverId:[UInt8] = [0xe1,0xe6,0xe1,0xfc,0xa0,0xeb,0xe7,0xec,0xed,0xfa,0xb2,0xa1,0xa8,0xe0,0xe9,0xfb,0xa8,0xe6,0xe7,0xfc,0xa8,0xea,0xed,0xed,0xe6,0xa8,0xe1,0xe5,0xf8,0xe4,0xed,0xe5,0xed,0xe6,0xfc,0xed,0xec]

private func properlyGolf(organ num: UInt8) -> UInt8 {
    return num ^ 136
}

/*: "icon_me_voice_white" :*/
fileprivate let noti_thereTitle:[Character] = ["i","c","o","n","_","m","e","_","v","o","i","c","e","_","w","h","i","t","e"]

/*: "btn_auto_write" :*/
fileprivate let main_blindKey:[Character] = ["b","t","n","_","a","u","t","o","_","w","r","i","t","e"]

/*: "Pending review" :*/
fileprivate let show_graduateServeTitle:String = "adjustment condition cigarettePendi"
fileprivate let app_calculateUrl:String = "ng constraint unable detect chin modify"
fileprivate let main_cycleStr:[Character] = ["r","e","v","i","e","w"]

/*: "get json error" :*/
fileprivate let show_snapValue:[Character] = ["g","e","t"," ","j","s","o","n"]
fileprivate let k_cameraName:String = "four strike burn fore again error"
...
class IssueOutsideAudioCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_serverId.map{properlyGolf(organ: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var audioBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.tillOfCreation(colors: UIColor.spectralColor(), size: CGSize(width: 155, height: 35)), for: .normal)
        //: btn.layer.cornerRadius = 17.5
        btn.layer.cornerRadius = 17.5
        //: btn.clipsToBounds = true
        btn.clipsToBounds = true
        //: btn.addTarget(self, action: #selector(recordBtnAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(view), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var playIconView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.lastTo(name: (String(noti_thereTitle))))
        //: return imag
        return imag
        //: }()
    }()
    ...
    lazy var editBtn: UIButton = {
        ...
        btn.setImage(UIImage.lastTo(name: (String(main_blindKey))), for: .normal)
        //: btn.addTarget(self, action: #selector(editBtnAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(modest), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension IssueOutsideAudioCell {
    ...
    func marshalRowAudioComputerSimulationPresentPastCompartment(model: GateMeasurable, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(show_graduateServeTitle.suffix(5)) + String(app_calculateUrl.prefix(3)) + String(main_cycleStr)).localized
    ...
    func recording() {
        ...
        do {
            ...
            let url = AliveEffectTool.default.proscenium(type: .Play_Audio_Wave)
            ...
            printLog(message: (String(show_snapValue) + String(k_cameraName.suffix(6))))
        }
    }
}
