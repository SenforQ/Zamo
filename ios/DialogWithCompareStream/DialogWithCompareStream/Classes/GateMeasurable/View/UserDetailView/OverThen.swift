...
fileprivate let data_manageName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_gift_placeholder" :*/
fileprivate let appDynamicsName:[Character] = ["i","c","o","n","_","g","i","f","t","_"]
fileprivate let kVideoData:[Character] = ["p","l","a"]
fileprivate let user_properlyKey:String = "celato"

/*: "Gift" :*/
fileprivate let user_tableMsg:String = "red exposure target decrease protectionGift"
...
class OverThen: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_manageName.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .judgeAdvertising(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.lastTo(name: (String(appDynamicsName) + String(kVideoData) + user_properlyKey.replacingOccurrences(of: "lat", with: "h") + "lder"))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(user_tableMsg.suffix(4))).localized
...
extension OverThen {
    ...
    func a(giftModel: ToothPeerMeasurable, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.contactMoment(urlStr: giftModel.img)
