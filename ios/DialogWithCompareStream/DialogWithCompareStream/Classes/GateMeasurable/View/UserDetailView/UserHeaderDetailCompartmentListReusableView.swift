...
fileprivate let noti_endValue:[UInt8] = [0xe0,0xe5,0xe0,0xeb,0x9f,0xda,0xe6,0xdb,0xdc,0xe9,0xb1,0xa0,0x97,0xdf,0xd8,0xea,0x97,0xe5,0xe6,0xeb,0x97,0xd9,0xdc,0xdc,0xe5,0x97,0xe0,0xe4,0xe7,0xe3,0xdc,0xe4,0xdc,0xe5,0xeb,0xdc,0xdb]

fileprivate func calculateRender(look num: UInt8) -> UInt8 {
...
fileprivate let app_shadowName:String = "favorite operation warnbtn_"
fileprivate let user_shouldName:String = "ic_stinvisible mic"
...
// __CLOSE_PRINT__
//
//  UserHeaderDetailCompartmentListReusableView.swift
//  AbroadTalking
//
...
class UserHeaderDetailCompartmentListReusableView: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_endValue.map{calculateRender(look: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var playimageView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.lastTo(name: (String(app_shadowName.suffix(4)) + "dynam" + String(user_shouldName.prefix(5)) + "op_nor")))
        //: return imag
        return imag
        //: }()
    }()
...
extension UserHeaderDetailCompartmentListReusableView {
    //: func configModel(videoUrl: String, imgUrl: String ) {
    func original(videoUrl: String, imgUrl: String) {
        //: self.videoUrl = videoUrl
        self.videoUrl = videoUrl
        //: self.coverView.setUrlImage(urlStr: imgUrl)
        self.coverView.contactMoment(urlStr: imgUrl)
    }
    ...
    func pause() {
        ...
        self.player.gapCap(url: videoUrl, view: self.coverView)
...
extension UserHeaderDetailCompartmentListReusableView: DirectlyThen {
