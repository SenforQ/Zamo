...
/*: "detection" :*/
fileprivate let kPureTotalStr:[Character] = ["d","e","t","e","c","t"]
fileprivate let constBelowContent:String = "ION"

/*: "aiff" :*/
fileprivate let dataNoseEffName:[Character] = ["a","i","f","f"]
...
class ShotThen: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = ShotThen()
    ...
    func stat() {
        ...
        let soundFilePath = AliveEffectTool.default.panelBirthday(name: (String(kPureTotalStr) + constBelowContent.lowercased()), type: (String(dataNoseEffName)))
