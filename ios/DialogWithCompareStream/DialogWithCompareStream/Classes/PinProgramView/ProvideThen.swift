...
/*: "&sr=6" :*/
fileprivate let notiDrawingPowMsg:String = "restore visual cost strong&sr=6"
...
enum LicenseTitleLiteral: String, CaseIterable {
...
enum SpeakForeverCustomReflectable: String {
...
class ProvideThen: NSObject {
    ...
    class func north(urlType: SpeakForeverCustomReflectable) -> String {
        //: var url = MentionTriggerAppManager.share.appConfigMode.urlH5Domain
        var url = MentionTriggerAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(MentionTriggerAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : MentionTriggerAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(MentionTriggerAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : MentionTriggerAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage.appending((String(notiDrawingPowMsg.suffix(5))))
            //: url.append(MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(MentionTriggerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
