...
fileprivate let notiPutVerticalMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class TerminatedView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiPutVerticalMsg.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var progressView: DrivePackReactiveCompatible = {
        ...
        let v = DrivePackReactiveCompatible(frame: self.frame, progressBgColor: self.progressBgColor, progressPlayedColor: self.progressPlayedColor, progressCachedColor: self.progressCachedColor)
    ...
    private lazy var panGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(outsideTing(gesture:)))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(gestureWith(gesture:)))
        //: return v
        return v
        //: }()
    }()
...
extension TerminatedView {
    //: @objc func panGesture(gesture: UIPanGestureRecognizer) {
    @objc func outsideTing(gesture: UIPanGestureRecognizer) {
        // 移动的距离
    ...
    @objc func gestureWith(gesture: UIPanGestureRecognizer) {
...
extension TerminatedView {
    ...
    private func aboveSampleDestroy() {}
}
