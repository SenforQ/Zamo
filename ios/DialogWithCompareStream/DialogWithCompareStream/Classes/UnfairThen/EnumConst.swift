...
enum LoginExpressionConvertible: String {
    //: case AppleLogin
...
enum AlongVolumeMiscellaneaFontType {
    //: case Regular
    case Regular
    //: case Medium
    case Medium
...
enum GrayAdditiveArithmetic: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum TopicKeyRepresentable: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum StandardPinColumnConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum HeadeVolumeStatusEquatable: Int {
    //: case isOnGoing = 0
...
@objc enum AidNameConvertible: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ForeverHashable: Int {
    //: case Unavailable = 0
...
enum MarketCaseIterable: CaseIterable {
