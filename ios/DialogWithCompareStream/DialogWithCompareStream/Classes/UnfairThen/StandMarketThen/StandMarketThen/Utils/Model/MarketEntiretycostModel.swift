...
//: @objcMembers public class MarketEntiretycostModel: JSONModel {
@objcMembers public class MarketEntiretycostModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = ConstraintTransformable.Face
...
//: @objc extension MarketEntiretycostModel {
@objc extension MarketEntiretycostModel {
    //: func initWith(suiteType: BeautyItemType)-> MarketEntiretycostModel {
    func nature(suiteType: ConstraintTransformable) -> MarketEntiretycostModel {
        //: let model = MarketEntiretycostModel.init()
        let model = MarketEntiretycostModel()
