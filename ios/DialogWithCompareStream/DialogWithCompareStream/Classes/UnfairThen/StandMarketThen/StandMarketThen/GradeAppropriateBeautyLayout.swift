...
// __CLOSE_PRINT__
//
//  GradeAppropriateBeautyLayout.swift
//  AbroadTalking
//
...
class GradeAppropriateBeautyLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        layoutContentSize = CGSize(width: Int(show_objectValue) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let x = page * Int(show_objectValue) + pageCol * (itemWidth )
