...
@objcMembers open class DriveReactiveCompatible: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = DriveReactiveCompatible()
    //: private(set) var currLanguage: String = EverlastinglyReactiveCompatible.getSystemLangCode()
    private(set) var currLanguage: String = EverlastinglyReactiveCompatible.feedAnimal()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func numberervalLanguage(_ language: String) {
...
extension String {
    ...
    public func takeHomeDiskMini(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = AliveEffectTool.default.languagePath
