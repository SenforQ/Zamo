...
fileprivate let mainPersonalFormat:[UInt8] = [0xf2,0xf5,0xf2,0xef,0xb3,0xf8,0xf4,0xff,0xfe,0xe9,0xa1,0xb2,0xbb,0xf3,0xfa,0xe8,0xbb,0xf5,0xf4,0xef,0xbb,0xf9,0xfe,0xfe,0xf5,0xbb,0xf2,0xf6,0xeb,0xf7,0xfe,0xf6,0xfe,0xf5,0xef,0xfe,0xff]

private func warningTraveler(instance num: UInt8) -> UInt8 {
    return num ^ 155
}

/*: "Cancel" :*/
fileprivate let appWealthyValue:[Character] = ["C","a","n","c","e"]
fileprivate let app_decideFoundPath:[Character] = ["l"]

/*: "Sure" :*/
fileprivate let notiTunKey:[Character] = ["S","u","r","e"]
...
class UnfairThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainPersonalFormat.map{warningTraveler(instance: $0)}, encoding: .utf8)!)
    }
    ...
    private func titleBy() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(examine))
        ...
        cancelButton.setTitle((String(appWealthyValue) + String(app_decideFoundPath)).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(announcementRoot(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(notiTunKey)).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(replaceButton(button:)), for: .touchUpInside)
    ...
    @objc func announcementRoot(button _: UIButton) {
        //: dismissView()
        examine()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func replaceButton(button _: UIButton) {
        //: dismissView()
        examine()
    }

    //: func showView() {
    func scriptEstimated() {
