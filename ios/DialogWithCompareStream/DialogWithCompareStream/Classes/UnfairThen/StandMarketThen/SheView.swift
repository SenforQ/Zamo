...
class SheView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        strongColor(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        strongColor(placeholder: nil, placeholderColor: nil)
    }
}
...
extension SheView {
    ...
    private func strongColor(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(RidLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(RidLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-RidLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: LipogramContainerInset().top, left: LipogramContainerInset().left, bottom: LipogramContainerInset().bottom, right: LipogramContainerInset().right)
...
extension SheView: UITextViewDelegate {
