...
Pod::Spec.new do |s|
  s.name         = "DialogWithCompareStream"
  s.version      = "1.0.0"
  s.summary      = "iOS DialogWithCompareStream Module."
  s.author       = { "DialogWithCompareStream" => "DialogWithCompareStream.me" }
  s.homepage     = "DialogWithCompareStream"
  s.source       = { :git => "http://DialogWithCompareStream.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'DialogWithCompareStream/Classes/**/*'
  s.resources = "DialogWithCompareStream/Resources/*.bundle"
  s.vendored_libraries = 'DialogWithCompareStream/Classes/**/*.a'
