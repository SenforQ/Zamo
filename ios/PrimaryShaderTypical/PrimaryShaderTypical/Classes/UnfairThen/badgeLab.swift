...
class MentionBadgeLab: UILabel {
    ...
    //: private func setup() {
    private func computeVia() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.fryingPan().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.landEnableSize(type: .Medium, fontSize: 11)
...
class NeverthelessAlignLb: UILabel {
