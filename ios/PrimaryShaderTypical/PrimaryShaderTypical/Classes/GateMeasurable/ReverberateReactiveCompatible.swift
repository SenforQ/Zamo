...
// __CLOSE_PRINT__
//
//  ReverberateReactiveCompatible.swift
//  AbroadTalking
//
...
class ReverberateReactiveCompatible: NSObject {
    //: var day = ""                                   // 日期
    var day = "" // 日期
    //: var addIcon = ""                               // 签到添加金币数
    var addIcon = "" // 签到添加金币数
    //: var type: DailyItemType = .Overdue_NotSignIn
    var type: AuthorizeItemType = .Overdue_NotSignIn // 签到类型
}
