...
fileprivate let noti_linkPath:[UInt8] = [0x7d,0x82,0x7d,0x88,0x3c,0x77,0x83,0x78,0x79,0x86,0x4e,0x3d,0x34,0x7c,0x75,0x87,0x34,0x82,0x83,0x88,0x34,0x76,0x79,0x79,0x82,0x34,0x7d,0x81,0x84,0x80,0x79,0x81,0x79,0x82,0x88,0x79,0x78]

fileprivate func mVersion(pic num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let main_numberFilePath:String = "hood eye present backbtn_me_"
fileprivate let mainSumUrl:String = "ebotit"

/*: "Add" :*/
fileprivate let k_rangeName:String = "Addmissing position satisfy listen"
...
class RestrictionThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_linkPath.map{mVersion(pic: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.lastTo(name: (String(main_numberFilePath.suffix(7)) + mainSumUrl.replacingOccurrences(of: "bot", with: "d"))))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.text = (String(k_rangeName.prefix(3))).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
