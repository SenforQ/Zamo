...
fileprivate let k_canFormat:[UInt8] = [0xc0,0xc7,0xc0,0xdd,0x81,0xca,0xc6,0xcd,0xcc,0xdb,0x93,0x80,0x89,0xc1,0xc8,0xda,0x89,0xc7,0xc6,0xdd,0x89,0xcb,0xcc,0xcc,0xc7,0x89,0xc0,0xc4,0xd9,0xc5,0xcc,0xc4,0xcc,0xc7,0xdd,0xcc,0xcd]

private func problemMaterial(moon num: UInt8) -> UInt8 {
    return num ^ 169
}

/*: "btn_me_edit" :*/
fileprivate let noti_thresholdStr:String = "anon simply ownerbtn_me"
...
class WritingView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_canFormat.map{problemMaterial(moon: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.lastTo(name: (String(noti_thresholdStr.suffix(6)) + "_edit")))
...
extension WritingView {
    ...
    func satisfyLine(titile: String, row: Int, isLast: Bool) {
    ...
    func identityDetail(detail: String) {
    ...
    func publishWrap() {
        ...
        titleBLB.font = UIFont.landEnableSize(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.landEnableSize(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
    ...
    func trenchMaterial(detail: String) {
        //: index = 0
        index = 0
        //: islast = true
        islast = true
