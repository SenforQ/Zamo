...
fileprivate let show_profileDetailText:[UInt8] = [0xc7,0xcc,0xc7,0xd2,0x86,0xc1,0xcd,0xc2,0xc3,0xd0,0x98,0x87,0x7e,0xc6,0xbf,0xd1,0x7e,0xcc,0xcd,0xd2,0x7e,0xc0,0xc3,0xc3,0xcc,0x7e,0xc7,0xcb,0xce,0xca,0xc3,0xcb,0xc3,0xcc,0xd2,0xc3,0xc2]

fileprivate func piProvide(former num: UInt8) -> UInt8 {
...
class SimplyStreamsView: ExtensiveView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_profileDetailText.map{piProvide(former: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var renderView: UIView = { // 视频渲染视图
        ...
        view.backgroundColor = .roundChromaticColor()
        //: view.layer.cornerRadius = 8
        view.layer.cornerRadius = 8
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
...
extension SimplyStreamsView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func cleanLive(liveUrl: String) {
...
extension SimplyStreamsView: TXLivePlayListener {
