...
fileprivate let k_enterTitle:[UInt8] = [0xca,0xcd,0xca,0xd7,0x8b,0xc0,0xcc,0xc7,0xc6,0xd1,0x99,0x8a,0x83,0xcb,0xc2,0xd0,0x83,0xcd,0xcc,0xd7,0x83,0xc1,0xc6,0xc6,0xcd,0x83,0xca,0xce,0xd3,0xcf,0xc6,0xce,0xc6,0xcd,0xd7,0xc6,0xc7]

private func mirrorGender(enthusiasm num: UInt8) -> UInt8 {
    return num ^ 163
}

/*: "icon_mini_voice_end" :*/
fileprivate let main_createValue:[Character] = ["i","c","o","n","_","m","i","n","i","_","v"]
fileprivate let const_resumeBusinessId:String = "contain birthdayoice_end"

/*: "#F95151" :*/
fileprivate let data_compoundValue:[Character] = ["#","F","9","5","1","5"]
fileprivate let noti_processingMsg:String = "1"

/*: "End of call" :*/
fileprivate let show_assetName:[Character] = ["E","n"]
fileprivate let noti_lowGlobalTitle:[Character] = ["d"," ","o","f"," ","c","a","l","l"]

/*: "img_home_shadow_icon" :*/
fileprivate let noti_platSkinMsg:String = "img_hmodify draw"
fileprivate let constClearlyBrightValue:String = "hadomay"
fileprivate let kCommonId:String = "shall"
...
// __CLOSE_PRINT__
//
//  WeightReactiveCompatible.swift
//  AbroadTalking
//
...
class WeightReactiveCompatible: ExtensiveView {
    // 小窗口通话状态
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_enterTitle.map{mirrorGender(enthusiasm: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.lastTo(name: (String(main_createValue) + String(const_resumeBusinessId.suffix(8))))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(data_compoundValue) + noti_processingMsg.capitalized))
        ...
        lab.text = (String(show_assetName) + String(noti_lowGlobalTitle)).localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.lastTo(name: (String(noti_platSkinMsg.prefix(5)) + "ome_s" + constClearlyBrightValue.replacingOccurrences(of: "may", with: "w") + "_ico" + kCommonId.replacingOccurrences(of: "shall", with: "n")))
...
extension WeightReactiveCompatible {
    /// 构建视频小窗口
    //: static func buildVideoMiniView() -> TalkingVideoMiniView {
    static func groin() -> WeightReactiveCompatible {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = WeightReactiveCompatible(frame: .zero)
    ...
    func messagePoint(point: String) {
...
extension WeightReactiveCompatible {
    ...
    private func setupNoConstraint() {
