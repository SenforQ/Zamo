 ...
 *
 *  TrimDelegate 协议和 ActuallyTableViewController 类。
 *  ActuallyTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 ActuallyTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class ActuallyTableViewController;
//: @class EyebrowReactiveCompatible;
@class EyebrowReactiveCompatible;
//: @class TriggerCellData;
@class TriggerCellData;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
@protocol TrimDelegate <NSObject>
...
- (void)cutLock:(ActuallyTableViewController *)controller;
...
- (void)presentController:(ActuallyTableViewController *)controller;
...
- (BOOL)conversation:(ActuallyTableViewController *)controller time:(UIView *)view;
 ...
 */
//: - (TriggerCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (TriggerCellData *)toFilter:(ActuallyTableViewController *)controller running:(V2TIMMessage *)data;
 ...
 */
//: - (EyebrowReactiveCompatible *)messageController:(TUIMessageController *)controller onShowMessageData:(TriggerCellData *)data;
- (EyebrowReactiveCompatible *)message:(ActuallyTableViewController *)controller ingredient:(TriggerCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(EyebrowReactiveCompatible *)cell;
- (void)step:(ActuallyTableViewController *)controller indicator:(EyebrowReactiveCompatible *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(EyebrowReactiveCompatible *)cell;
- (void)select:(ActuallyTableViewController *)controller notice:(EyebrowReactiveCompatible *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(TriggerCellData *)data;
- (void)menu:(ActuallyTableViewController *)controller at:(NSInteger)menuType become:(TriggerCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(EyebrowReactiveCompatible *)cell;
- (void)view:(ActuallyTableViewController *)controller direction:(EyebrowReactiveCompatible *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(TriggerCellData *)cellData;
- (void)mouth:(ActuallyTableViewController *)controller link:(TriggerCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(TriggerCellData *)cellData;
- (void)array:(ActuallyTableViewController *)controller kind:(TriggerCellData *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         ActuallyTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】ActuallyTableViewController
...
@interface ActuallyTableViewController : UITableViewController

/**
 *  执行 TrimDelegate 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<TrimDelegate> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<TriggerCellData *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成TriggerCellData
 */
