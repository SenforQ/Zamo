...
@objcMembers public class BorderReactiveCompatible: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func harvestMoon(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class LifeViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: BorderReactiveCompatible?
    ...
    @objc dynamic public func disembarrass(with data: BorderReactiveCompatible) {
        //: self.data = data
        self.data = data
    }
} 
