...
@objc public enum StillValueConvertible: UInt {
...
@objc public enum BeTransformable: UInt {
...
// MARK: - TriggerCellData

/**
 * 【模块名称】TriggerCellData
 ...
 */
//: @objcMembers public class TriggerCellData: TCommonCellData {
@objcMembers public class TriggerCellData: BorderReactiveCompatible {
    ...
    public var direction: BeTransformable = .MsgDirectionIncoming
    ...
    public var translateStatus: StillValueConvertible = .MsgTranslate_init
    ...
    public var msgModel: OrganModel = OrganModel()
    ...
    public var cellLayout: StandReactiveCompatible!
    ...
    public init(direction: BeTransformable) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.buttonShape()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = StandReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = StandReactiveCompatible(isIncomming: false)
    ...
    public func misestimate() -> CGSize {
        //: return CGSize.zero
        return CGSize.zero
    }
    ...
    public override func harvestMoon(_ width: CGFloat) -> CGFloat {
