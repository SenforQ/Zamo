...
/*: ".png" :*/
fileprivate let k_cornerStr:[Character] = [".","p","n","g"]
...
//: @objcMembers public class MezuzahCellData: TalkingChatMsgBaseCellData {
@objcMembers public class MezuzahCellData: SumroductionCellData {
    ...
    override public var msgModel: OrganModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.cookieOp(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func red(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(kHalfTurnDomainMsg)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + MentionTriggerAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + MentionTriggerAppManager.share.loginUserMode.userID + (String(k_cornerStr))
        ...
        let imageData = UIImage.captureMenu(image, storage: 2 * 1024)
