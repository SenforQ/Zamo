...
@interface ConfirmationModel : JSONModel
...
@property (nonatomic, strong) ManyModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ChatEveryoneModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) TrimRuleModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) RedModel *wantGift; /// 想要礼物
...
@interface ChatEveryoneModel: JSONModel
...
@interface TrimRuleModel: JSONModel
...
@interface EnableingModel : JSONModel
...
@interface PersonalModel : JSONModel
...
@interface MarkBarrierModel : JSONModel
...
@interface SumerventionModel : JSONModel
...
@interface CompareModel : JSONModel
...
@property (nonatomic, strong) EveryoneModel *renderData;
...
@interface EveryoneModel : JSONModel
