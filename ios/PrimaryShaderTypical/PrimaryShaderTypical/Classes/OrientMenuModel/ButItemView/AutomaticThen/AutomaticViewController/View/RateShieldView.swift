...
fileprivate let mainCaptureValue:[UInt8] = [0x8a,0x8d,0x8a,0x97,0xcb,0x80,0x8c,0x87,0x86,0x91,0xd9,0xca,0xc3,0x8b,0x82,0x90,0xc3,0x8d,0x8c,0x97,0xc3,0x81,0x86,0x86,0x8d,0xc3,0x8a,0x8e,0x93,0x8f,0x86,0x8e,0x86,0x8d,0x97,0x86,0x87]

private func loopChangeShake(stand num: UInt8) -> UInt8 {
    return num ^ 227
}
...
class RateShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func belowBy(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return RateShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainCaptureValue.map{loopChangeShake(stand: $0)}, encoding: .utf8)!)
    }
...
extension RateShieldView {
    //: func addSafeZoneView() {
    func topBillingSelect() {
