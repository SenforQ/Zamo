...
@objcMembers class FirstThen: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: WouldModelType?
    //: var gift: TalkingMsgGiftModel?
    var gift: AcquisitionHandyJSON?
    //: var user: TalkingMsgUserModel?
    var user: CommunicateMeasurable?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: OutsideTransformable?
...
class WouldModelType: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class CommunicateMeasurable: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class OutsideTransformable: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class AcquisitionHandyJSON: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
