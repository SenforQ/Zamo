...
// __CLOSE_PRINT__
//
//  ComprehensibleReactiveCompatible.swift
//  AbroadTalking
//
...
open class ComprehensibleReactiveCompatible: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = ComprehensibleReactiveCompatible.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func crucifyInit() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(tagAppearChange),
    ...
    @objc private func tagAppearChange() {
