...
Pod::Spec.new do |s|
  s.name         = "PrimaryShaderTypical"
  s.version      = "1.0.0"
  s.summary      = "iOS PrimaryShaderTypical Module."
  s.author       = { "PrimaryShaderTypical" => "PrimaryShaderTypical.me" }
  s.homepage     = "PrimaryShaderTypical"
  s.source       = { :git => "http://PrimaryShaderTypical.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
